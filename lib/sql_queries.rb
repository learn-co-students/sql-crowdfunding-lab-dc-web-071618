...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) AS new_amount FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING new_amount >= 0"
end
